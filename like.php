...
if(isset($_POST['like_button']))
{
   ...
   $insert_user = mysqli_query($connect,"INSERT INTO likes VALUES('','$userLoggedIn','$post_id')");
...
$num_rows = mysqli_num_rows($check_query);
    ...
    //if user like the post then it show unlike button otherwise it show it like button
