...
if(isset($_GET['u']))
{
	$user_to = $_GET['u'];//this get u from url
}
else
{
	$user_to = $message_obj->getMostRecentUser();//this mean start a conversation which send a message and if not's true then it show new which mean find new user to send message
