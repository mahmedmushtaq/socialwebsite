...
<?php $profile_user_obj = new User($connect,$username);
...
//this mean own profile does not show his own friend request and other feature this fearture only show when it open another friend client
...
<ul class="nav nav-tabs" role="tablist" id="profileTabs">
  <li role="presentation" class="active"><a href="#newsfeed_div" aria-control="newsfeed_div" role="tab" data-toggle="tab">Newsfeed</a></li>
 <!-- <li role="presentation"><a href="#about_div" aria-control="about_div" role="tab" data-toggle="tab">Profile</a></li>-->
  <li role="presentation"><a href="#messages_div"  aria-control="messages_div" role="tab" data-toggle="tab">Messages</a></li>
</ul>

<div class="tab-content">

<div rol="tobpanel" class="tab-pane fade in active" id="newsfeed_div">
...
<img id="loading"src="assets/images/icons/loadingone.gif">
     ...
     <div rol="tobpanel" class="tab-pane fade " id="about_div">
  
    </div>

<div rol="tobpanel" class="tab-pane fade" id="messages_div">
