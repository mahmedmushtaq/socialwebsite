...
class Message
{
	...
	public function getMostRecentUser()
	{
        ...
        //is pory function ki defination yah hy k
        /* sub sey pahly jo user login hy yah us ka naam userloggedin k andr store krwaye ga us k bad aik
        query lagy gi jo check kry gi k aia esy koi msj aia hy yah is ney koi snd kia hy agr dono mein sey koi b true nhi 
        ho ga to yah galse return kr dy or agr true hua to yah query us mein sey user_to or user_from get kry gi agr 
        js ney login kia hy usy kisi ney message snd kia hua to yah us ka naam send kry gi or agr nhi kia hua to jo is ney msj kia ho
        ga kisi ko wo naam send kr dy gi
	...
	public function getMessages($otherUser)
	{
			$userLoggedIn = $this->user_obj->getUsername();
				$data = "";
             $query = mysqli_query($this->con,"UPDATE messages SET opened='yes' WHERE user_to='$userLoggedIn' user_from='$otherUser'");
