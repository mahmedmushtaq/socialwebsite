...
//this if mean return user friends if not friends find then it username shows
...
else
{
 ...
 public function getProfilePic(){
	...
	public function removeFriend($user_to_remove)
	{
		...
		//the name of user which want the client to remove is store in user_to_remove
...
{
  //user_to_check those user which visit user profile
